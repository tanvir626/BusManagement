...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total Route: <asp:Label ID="Label3" runat="server" ForeColor="Red" Text="Label"></asp:Label>

                     </p>
        <p>

                     Total Customer: <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="Label"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ticket Sold: <asp:Label ID="Label4" runat="server" ForeColor="Red" Text="Label"></asp:Label>
                     &nbsp;</p>
        <p>
